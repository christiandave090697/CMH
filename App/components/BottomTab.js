...
export default class BottomTab extends Component {
  ...
  tabIcons(isFocused, tabID) {
    switch (tabID) {
      case 0:
        return isFocused ? (
          <HomeActive width={BOTTOM_TAB_ICON_WIDTH} height={BOTTOM_TAB_ICON_HEIGHT} />
        ) : (
          <HomeInactive width={BOTTOM_TAB_ICON_WIDTH} height={BOTTOM_TAB_ICON_HEIGHT} />
        );
      case 1:
        return isFocused ? (
          <SearchActive width={BOTTOM_TAB_ICON_WIDTH} height={BOTTOM_TAB_ICON_HEIGHT} />
        ) : (
          <SearchInactive width={BOTTOM_TAB_ICON_WIDTH} height={BOTTOM_TAB_ICON_HEIGHT} />
        );
      case 2:
        return isFocused ? (
          <CategoriesActive width={BOTTOM_TAB_ICON_WIDTH} height={BOTTOM_TAB_ICON_HEIGHT} />
        ) : (
          <CategoriesInactive width={BOTTOM_TAB_ICON_WIDTH} height={BOTTOM_TAB_ICON_HEIGHT} />
        );
      case 3:
        return isFocused ? (
          <LibraryActive width={BOTTOM_TAB_ICON_WIDTH} height={BOTTOM_TAB_ICON_HEIGHT} />
        ) : (
          <LibraryInactive width={BOTTOM_TAB_ICON_WIDTH} height={BOTTOM_TAB_ICON_HEIGHT} />
        );
      default:
    }
  }
